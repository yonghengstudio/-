...
local Translations = {
    ...
    ["Auto Permanent Buy(Beneficial Only) = "自动购买永久(仅有益的)",
    ["Permanent Buy all Buttons"] = "购买所有按钮永久性",
    ["Permannent Buy Picks(Optional)"] = "购买永久性部件(选择)",
    ["Auto-pick (best buttons)"] = "自动购买部件["Auto Collect"] = "自动收集",
    ["Drops"] = "掉落物",
